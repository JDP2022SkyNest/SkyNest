...
public class CompanyController {
  ...
  @ApiResponses(
      value = {
        @ApiResponse(responseCode = "200", description = "Successfully deleted a company"),
        @ApiResponse(
            responseCode = "401",
            description = "Invalid session token",
            content = {
            ...
            content = {
              @Content(
                  ...
                  examples = {
                    @ExampleObject(
                        value =
                            "{\"messages\":[\"Company doesn't exist\"],"
                                + " \"status\": \"409\","
                                + " \"timestamp\": \"2022-06-03 16:18:12\"}")
                  })
            }),
  ...
  public void deleteCompany(@PathVariable UUID uuid) {
    CompanyResponse companyResponse = companyService.deleteCompany(uuid);
    log.info("Company {} was successfully deleted", companyResponse.getName());
  }
}
