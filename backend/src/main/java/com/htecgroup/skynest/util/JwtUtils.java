...
public class JwtUtils {
  ...
  public String generateJwtEmailToken(String email) {
  ...
  public String getEmailFromJwtEmailToken(String token) {
  ...
  public String buildVerificationEmail(String email, String link) {
  ...
  public String buildPasswordResetEmail(String email, String link) {
    return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n"
            ...
            + "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">Hi "
            + email
            + ",</p><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> You have requested a password reset. If this was you, continue to the link below: </p><blockquote style=\"Margin:0 0 20px 0;border-left:10px solid #b1b4b6;padding:15px 0 0.1px 15px;font-size:19px;line-height:25px\"><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> <a href=\""
            + link
