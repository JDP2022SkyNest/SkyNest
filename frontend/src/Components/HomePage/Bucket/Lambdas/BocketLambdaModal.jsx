...
const BucketLambdaModal = ({ bucketId }) => {
   ...
   const allComponents = [
      { name: "All Lambdas", comp: <AllLambdas setErrorMsg={setErrorMsg} setSuccessMsg={setSuccessMsg} bucketId={bucketId} /> },
      { name: "Active Lambdas", comp: <ActiveLembdas setErrorMsg={setErrorMsg} bucketId={bucketId} /> },
   ];
...
export default BucketLambdaModal;
