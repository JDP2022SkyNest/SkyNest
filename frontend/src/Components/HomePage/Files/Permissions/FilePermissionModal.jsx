...
import FileAllPermissions from "./FileAllPermissions";
import FileGrantPermission from "./FileGrantPermission";
import FileRevokePermission from "./FileRevokePermission";

const FilePermissionModal = ({ objectId }) => {
